...
class SAMBatch(Batch):
    ...
    is_gt: Optional[torch.Tensor] = (
        None  # tensor of size (batch_size, ), specifying for each sample wether it is ground truth (and therefore binary) or a pseudo label and therefore continuous
    )
